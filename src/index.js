...
const router = createCommandRouter({
  ...
  "get-wallet": async () => {
    ...
    if (!walletId)
      throw new W3ActionError("MISSING_INPUT", "wallet-id required");
  ...
  "get-transaction": async () => {
    ...
    if (!transactionId)
      throw new W3ActionError("MISSING_INPUT", "transaction-id required");
  ...
  "get-policy": async () => {
    ...
    if (!policyId)
      throw new W3ActionError("MISSING_INPUT", "policy-id required");
  ...
  "get-quorum": async () => {
    ...
    if (!quorumId)
      throw new W3ActionError("MISSING_INPUT", "quorum-id required");
  ...
  "get-intent": async () => {
    ...
    if (!intentId)
      throw new W3ActionError("MISSING_INPUT", "intent-id required");
  ...
  "get-condition-set": async () => {
    ...
    if (!conditionSetId)
      throw new W3ActionError("MISSING_INPUT", "condition-set-id required");
    setJsonOutput(
      "result",
  ...
  "get-aggregation": async () => {
    ...
    if (!aggregationId)
      throw new W3ActionError("MISSING_INPUT", "aggregation-id required");
...
function setup() {
  ...
  function pb() {
    if (!body)
      throw new W3ActionError("MISSING_INPUT", "body input is required");
